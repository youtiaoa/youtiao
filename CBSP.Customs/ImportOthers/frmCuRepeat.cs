...
{
    public partial class frmCuRepeat : frmBaseDataBusiness
    {
        bllImDeclare bll;
        public frmCuRepeat()
        {
        ...
        protected override int CustomerAuthority
        {
            get
            {
                return base.CustomerAuthority - FunctionAuthorityCommon.ADD - FunctionAuthorityCommon.EDIT - FunctionAuthorityCommon.DELETE + FunctionAuthority.EX_08;//扩展申报;
            }
        }
        ...
        {
            base.IniButton();
            if (CurrentAuthorityExist(FunctionAuthority.EX_08))//如果有扩展权限
            {
                ...
                InsertAfterButton(ButtonNames.btnView, btn, FunctionAuthority.EX_08, "补打", DoRepeat);
            }
        }
        ...
        /// 补打
        /// </summary>
        private void DoRepeat(object sender, ItemClickEventArgs e)
        {
            base.DoRepeat(sender);
