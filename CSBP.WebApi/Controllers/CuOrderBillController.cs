...
{
    public class CuOrderBillController : BaseController
    {
        CuOrderBillService service = new CuOrderBillService();
        private UserService _userService = new UserService();
        public void PrepareCuInsertInfo(CuOrderHead entity,User user,string guid)
        {
            if(guid != null)
            {
                entity.GUID = guid;
            ...
            {
                entity.GUID = BillNoGenerator.NewOrderBillNo();
            }
            foreach (var e in entity.CuOrderLists)
            {
                e.GUID = entity.GUID;
            }
        ...
        public IHttpActionResult PostCuOrderBill(string token, CuOrderBillModel orderBill)
        {
